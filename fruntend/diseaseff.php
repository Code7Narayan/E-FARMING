...
#p1{
 ...
 <?php    include ("search.php");
            ...
            <div class="form-group input-group col-md-offset-3 col-md-4" style="float:right">
              ...
              <input type="search" name="search" id="search" class="form-control" placeholder="Search Disease Here" onkeyup="return search()"><span class="input-group-addon"><i class="glyphicon glyphicon-search"></i></span></div>
