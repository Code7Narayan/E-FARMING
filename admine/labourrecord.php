        ...
        <table class="table table-hover" id="display">
            ...
            <?php
                   ...
                   while ($r=mysqli_fetch_array($res)) {
                    echo "<tr id='t1'>";
                    echo "<td><img src=../labour/".$r[3]."></td>";
                    echo "<td>".$r[0]."</td>";
                    echo "<td>".$r[1]."</td>";
                    echo "<td>".$r[4]."</td>";
                    echo "<td>".$r[2]."</td>";
                    echo "<td><a href='../database/savelabour.php?action=remove&name=".$r[0]."'role='button'class='btn btn-danger'><span class='glyphicon glyphicon-trash'aria-hidden='true'></span></button></td>";
                    echo "</tr>";
