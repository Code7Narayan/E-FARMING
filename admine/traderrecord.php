        ...
        <table class="table table-hover" id="display">
            ...
            <?php
                   ...
                   while ($r=mysqli_fetch_array($res)) {
                    ...
                    echo "<td>".$r[2]."</td>";
                    echo "<td>".$r[3]."</td>";
                    echo "<td><a href='../database/savetrader.php?action=remove&name=".$r[0]."'role='button'class='btn btn-danger'><span class='glyphicon glyphicon-trash'aria-hidden='true'></span></button></td>";
                    echo "</tr>";
